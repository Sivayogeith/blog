# Sage's Blog
**This is the frontend of my Blog, you can find the backend [here](https://github.com/Sivayogeith/blog-api)!**
...
```bash
git clone https://github.com/Sivayogeith/blog
```
...
bun dev
```
Now go to localhost:3000 to see the website!
