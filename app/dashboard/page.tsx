      ...
      <div className="flex flex-col flex-1 items-center">
        ...
        <div className="my-5 mx-10 lg:w-[80vw] w-[90vw] h-full flex justify-between flex-col">
          <div className="flex justify-between items-center mb-5">
            ...
            <button className="border border-secondary p-1 rounded-lg">
          ...
          {posts.map(async (post: Post) => (
            <div
              key={post.id}
              className="p-10 h-full border border-secondary rounded-2xl flex justify-between lg:flex-row flex-col-reverse gap-10"
            >
